...
if plateau == 1: #9 jetons
    ...
    ligne(1200, 100, 950, 310, epaisseur=3)
    ligne(300, 850, 555, 640, epaisseur=3)
    ligne(1200, 850, 950, 640, epaisseur=3)
